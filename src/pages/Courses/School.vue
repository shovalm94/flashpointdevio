<template>
  <div>
    <div class="list" v-for="course in userCourses">
      <q-card class="rectangle">
        ...
        <q-item-section>
          <div>
            <img src="https://cdn.quasar.dev/img/mountains.jpg" class="courseImg"
                 alt="https://cdn.quasar.dev/img/mountains.jpg">
          </div>
        </q-item-section>
        <q-card-section>
...
export default {
  ...
  computed:
    {
      ...mapState('courses', ['coursesList', 'getMore']),
      ...mapState('auth', ['user', 'userId', 'userCourses']),
    },
  methods: {
    ...mapActions('courses', ['getCourses', 'addStudentsToCourses', 'addCoursesToUser']),
    ...mapActions('auth', ['getUserCourses']),
    ...mapMutations('courses', ['setCourses', 'setGetMore', 'setCourseId']),
    ...mapMutations('auth', ['setUserCourses']),
    get() {
      this.getUserCourses()
    },
  },
